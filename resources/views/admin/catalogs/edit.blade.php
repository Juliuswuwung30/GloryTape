    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <div class="pb-5 border-b border-gray-200 sm:flex sm:items-center sm:justify-between">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Catalog</h3>
                    ...
                    <div>
                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                                <label for="image_path" class="block text-sm font-medium text-gray-700"> Catalog Picture
                                </label>
                                <div class="bg-white p7 rounded mx-auto">
                                    <div class="mb-4">
                                        <img src="{{ asset('storage/' . $catalog->image_path) }}"
                                            alt="{{ $catalog->image_path }}" style="width: 300px;">
                                    </div>
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <textarea id="description" name="description" rows="3"
                                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md">{{ $catalog->description }}</textarea>
                                </div>
                            </div>
